...
exports.listsReducer = exports.Lists_DefaultState = void 0;
...
var Lists_DefaultState = {
  listsData: null,
  visibilityState: _entities.VisibilityState.VISIBLE
};
exports.Lists_DefaultState = Lists_DefaultState;
var listsReducer = function listsReducer(state, action) {
  switch (action.type) {
    case _listsInterfaces.LISTS_ACTIONS.UPDATE_VISIBILITY_STATE:
      if (!state.listsData) {
    ...
    case _listsInterfaces.LISTS_ACTIONS.ADD_LIST_DATA:
      return _objectSpread(_objectSpread({}, state), {}, {
