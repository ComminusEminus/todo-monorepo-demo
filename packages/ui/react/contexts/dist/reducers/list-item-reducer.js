...
var listItemReducer = function listItemReducer(state, action) {
  switch (action.type) {
    case _listItemInterfaces.LIST_ITEM_ACTIONS.SET_COMPLETE_STATE:
      return _objectSpread(_objectSpread({}, state), {}, {
        completeState: action.payload
      });
    case _listItemInterfaces.LIST_ITEM_ACTIONS.UPDATE_VISIBILITY_STATE:
    ...
    case _listItemInterfaces.LIST_ITEM_ACTIONS.ADD_LIST_ITEM_DATA:
      return _objectSpread(_objectSpread({}, state), {}, {
