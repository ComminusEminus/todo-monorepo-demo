...
var Lists_DefaultContextState = {
  state: _allListsReducer.Lists_DefaultState,
...
var ListsProvider = function ListsProvider(_ref) {
  var children = _ref.children,
    ...
    defaultState = _ref$defaultState === void 0 ? _allListsReducer.Lists_DefaultState : _ref$defaultState;
  var _useReducer = (0, _react.useReducer)(_allListsReducer.listsReducer, _allListsReducer.Lists_DefaultState),
    _useReducer2 = _slicedToArray(_useReducer, 2),
    state = _useReducer2[0],
    dispatch = _useReducer2[1];
  (0, _react.useEffect)(function () {
    dispatch({
      type: _entities.LISTS_ACTIONS.ADD_LIST_DATA,
      payload: list
    });
  }, []);
