...
var _useGetTodolistByIdImplementation = require("../implementation/use-get-todolist-by-id-implementation");
...
var useFilterTodoListItems = function useFilterTodoListItems() {
  ...
  var _useGetTodoListByIdIm = (0, _useGetTodolistByIdImplementation.useGetTodoListByIdImplementation)({
      selectedTodoListId: selectedTodoListId,
      updateTodoListItems: updateTodoListItems
    }),
    todoListApiState = _useGetTodoListByIdIm.todoListApiState;
