...
export const DefaultScrimStyle = styled.div `
    position: absolute;
    z-index: 22000;
    display:flex;
...
`;
export const SideSheetScrimStyle = styled(DefaultScrimStyle) `
    left: 0px;
    top: 0px;
    bottom:0px;
    height: 100vh;
...
`;
export const BottomSheetScrimStyle = styled(DefaultScrimStyle) `
    left: 0px;
    right: 0px;
    bottom:0px;
...
`;
export const DialogScrimStyle = styled(DefaultScrimStyle) `
    left: 0px;
    right: 0px;
    bottom: 0px;
    top: 0px;
...
`;
//# sourceMappingURL=Scrim.style.js.map